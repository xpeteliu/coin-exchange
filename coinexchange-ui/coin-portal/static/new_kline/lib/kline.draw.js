...
function sendSocketRequest () {
  if (GLOBAL_VAR.stompClient) {
    ...
    GLOBAL_VAR.stompClient.on(`market-kline-${GLOBAL_VAR.market_from.toLowerCase()}-${GLOBAL_VAR.time_type}`, subscribeCallback)
    // 断线重连
    requestOverStomp()
  }
}
...
function on_size() {
  ...
  var B = $('#chart_tabbar')
  var G = p[0].style.display == 'inline'
  var n = B[0].style.display == 'block'
  var v = {}
  v.x = 0
  v.y = 0
  v.w = u
